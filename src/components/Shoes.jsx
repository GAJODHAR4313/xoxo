          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.9, y: 30 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 30 }}
              ...
              <div className="flex-1 p-6 md:p-12 bg-white dark:bg-xoxo-dark-card flex flex-col h-[60vh] md:h-auto overflow-y-auto no-scrollbar">
                ...
                <div className="flex items-center justify-between border-t border-neutral-100 dark:border-xoxo-dark-border pt-6 mt-auto">
                  ...
                  <button
                    ...
                    className={`px-8 py-4 rounded-2xl font-black uppercase italic text-xs tracking-[0.2em] transition-all shadow-lg ${selectedShoe.stock <= 0 ? 'bg-zinc-100 dark:bg-xoxo-dark-bg text-zinc-300 dark:text-zinc-600 cursor-not-allowed' : 'bg-black dark:bg-xoxo-gold text-white dark:text-black hover:shadow-2xl hover:-translate-y-1 border border-transparent dark:border-white/10'}`}
                  >
