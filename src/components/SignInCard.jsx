  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/90 backdrop-blur-xl">
      <motion.div
        ...
        className="bg-white w-full max-w-md p-8 sm:p-10 relative shadow-2xl border border-black/5"
      >
        ...
        <motion.form onSubmit={handleLogin} className="space-y-10">
          <div>
            <span className="text-[9px] font-black tracking-[0.4em] uppercase opacity-30 block mb-2">
          ...
          <div className="space-y-6">
            <input
              ...
              className="w-full py-4 border-b border-black/10 text-base lg:text-[10px] font-bold tracking-[0.2em] outline-none focus:border-black transition-all bg-transparent text-black"
          ...
          <button type="submit" disabled={loading} className="w-full bg-black text-white py-5 px-8 flex justify-between items-center group active:scale-[0.98] transition-all disabled:opacity-50">
          ...
          {!isAdminMode && (
            <div className="text-center">
              <p className="text-[9px] font-bold uppercase tracking-widest text-black/40">
                New here?{' '}
                <button type="button" onClick={onSwitch} className="text-black font-black hover:underline ml-1">
                  Join XOXO
                </button>
              </p>
            </div>
